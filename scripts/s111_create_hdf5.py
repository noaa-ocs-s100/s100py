...
def add_metadata(hdf_file):
    ...
    hdf_file.attrs.create('gridLandMaskValue', 0 , dtype=numpy.float32)
    ...
    hdf_file.attrs.create('nameSubregion', '' , dtype=dt)
    hdf_file.attrs.create('horizDatumReference', 'EPSG' , dtype=dt)
    hdf_file.attrs.create('dateTimeOfFirstRecord', '' , dtype=dt)
    hdf_file.attrs.create('dateTimeOfLastRecord', '' , dtype=dt)
    hdf_file.attrs.create('methodCurrentsProduct', '' , dtype=dt)

    #Enumeration types
    hdf_file.attrs.create('typeOfCurrentData', 0 , dtype=numpy.int32)
    hdf_file.attrs.create('dataCodingFormat', 0 , dtype=numpy.int32)
