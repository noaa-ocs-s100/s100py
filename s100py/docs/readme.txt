Docs need a python 3 environment with sphinx (2.4.4), sphinx-automodapi (0.12), sphinx-autodoc-typehints, sphinxcontrib-fulltoc and python-graphviz (0.13.2) which will automatically get graphviz too (really you only need graphviz).
